...
theMovieDb.common = {
  api_key: "8113e08a91615aebfcd498e00b0c8755",
  api_read_key: "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4MTEzZTA4YTkxNjE1YWViZmNkNDk4ZTAwYjBjODc1NSIsIm5iZiI6MTcyMTkxNzE0My4xNjI1NTIsInN1YiI6IjY2OTQ0ZjkwYzIyYTBmZDU0MjVmMzdjNCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.UPQFPbKfDj_mPaXFUA_g5QzQFuOQaFKjudH3VWQNfjs",
  ...
  getIcon: function(id, arrName) {
    id = id.toString();
    const icons = theMovieDb.common.data.icons;

    // Access the array within icons object using the provided arrName
    const arr = icons[arrName];
...
theMovieDb.movies = {
    ...
    */
    const options_2 = {
      ...
      headers: {
        ...
        Authorization: 'Bearer ' + theMovieDb.common.api_read_key
      }
    };
    
    fetch('https://api.themoviedb.org/3/movie/'+options.id+'/reviews', options_2)
  ...
  getProviders: function(options, success, error) {
    ...
    fetch('https://api.themoviedb.org/3/movie/'+options.id+'/watch/providers', options_2)
      .then(response => response.json())
      .then(response => success(response))
      .catch(err => error(err));
  },
...
theMovieDb.people = {
  ...
  getMovieCredits: function(options, success, error) {
    ...
    /*
    theMovieDb.common.client({
        url: "person/" + options.id + "/movie_credits?sort_by=popularity.desc" + theMovieDb.common.generateQuery(options)
      },
      success,
      error
    );
    */
    ...
    fetch('https://api.themoviedb.org/3/person/'+options.id+'/movie_credits?&sort_by=popularity.desc', options_2)
      .then(response => response.json())
      .then(response => success(response))
      .catch(err => error(err));
  },
  getTvCredits: function(options, success, error) {
    ...
    */
    ...
    fetch('https://api.themoviedb.org/3/person/'+options.id+'/tv_credits?&sort_by=popularity.desc', options_2)
      .then(response => response.json())
      .then(response => success(response))
      .catch(err => error(err));
  },
...
theMovieDb.tv = {
  ...
  getReviews: function(options, success, error) {
    ...
    */
    ...
    fetch('https://api.themoviedb.org/3/tv/'+options.id+'/reviews', options_2)
      .then(response => response.json())
      .then(response => success(response))
      .catch(err => error(err));
  },
  ...
  getProviders: function(options, success, error) {
    ...
    fetch('https://api.themoviedb.org/3/tv/'+options.id+'/watch/providers', options_2)
      .then(response => response.json())
      .then(response => success(response))
      .catch(err => error(err));
  },
...
fetch(document.currentScript.src.substring(0, document.currentScript.src.lastIndexOf('/') + 1)+'data.json')
  .then(response => response.json())
  .then(json => {theMovieDb.common.data = json})
